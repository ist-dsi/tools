...
public class InputProperty {
    ...
    public String toString() {
        return "InputProperty " + getPropertyName() + ", Type=" + getPropertyType() + ", Default=" + getPropertyDefaultValue()
                + ", Required=" + isPropertyRequired() + ", Persistent=" + isPropertyPersist() + ", Message="
                + getPropertyMessage() + " Metadata=" + metadataToString();
    }
