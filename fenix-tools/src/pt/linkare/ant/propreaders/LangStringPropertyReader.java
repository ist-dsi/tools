...
public class LangStringPropertyReader extends AbstractPropertyReader{
	...
	private List<String>[] buildLangOptions(String metaData) throws InvalidPropertySpecException {
		...
		List<String>[] optionsValuesRetVal=(List<String>[])new List[]{new ArrayList<String>(langs.size()),new ArrayList<String>(langs.size())};
	...
	private List<String>[] buildLangOptions() {
		...
		List<String>[] optionsValuesRetVal=(List<String>[])new List[]{new ArrayList<String>(locales.length),new ArrayList<String>(locales.length)};
