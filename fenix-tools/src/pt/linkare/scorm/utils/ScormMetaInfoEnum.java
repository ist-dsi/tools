...
public enum ScormMetaInfoEnum {
    ...
    TITLE("title", new FileSetMetaData("title", null, null, new String[0])), KEYWORD("keyword",
	    new FileSetMetaData("subject", null, null, new String[0])), GENERAL_LANGUAGE(
	    "generalLanguage", new FileSetMetaData("language", null, null, new String[0])), GENERAL_CATALOG(
	    "generalCatalog", new FileSetMetaData("identifier", null, null, new String[0])), GENERAL_ENTRY(
	    "generalEntry", new FileSetMetaData("generalEntry", null, null, new String[0])), GENERAL_AGGREGATIONLEVEL(
	    "generalAggregationLevel",
	    new FileSetMetaData("aggregationLevel", null, null, new String[0])), LIFECYCLE_VERSION(
	    "lifecycleVersion", new FileSetMetaData("version", null, null, new String[0])), LIFECYCLE_STATUS(
	    "lifecycleStatus", new FileSetMetaData("status", null, null, new String[0])),

    METAMETADATA_METADATASCHEMA("metametadataMetadataschema", new FileSetMetaData("metadatascheme",
	    null, null, new String[0])),

    TECHNICAL_LOCATION("technicalLocation", new FileSetMetaData("location", "uri", null, new String[0])), TECHNICAL_SIZE(
	    "technicalSize", new FileSetMetaData("size", null, null, new String[0])), TECHNICAL_DURATION(
	    "technicalDuration", new FileSetMetaData("duration", null, null, new String[0])), EDUCATIONAL_INTERACTIVITY_TYPE(
	    "educationalInteractivitytype", new FileSetMetaData("interactivityType", null, null,
		    new String[0])),
    ...
    CONTRIBUTE_ROLE("contributeRole", new FileSetMetaData("contributor", null, null, new String[0])), VCARD(
	    "vcard", new FileSetMetaData("vcard", null, null, new String[0])), DATE("date",
	    new FileSetMetaData("date", "created", null, new String[0])),

    FORMAT("format", new FileSetMetaData("format", "mimetype", null, new String[0])), LEARNING_RESOURCE(
	    "learningResource", new FileSetMetaData("type", null, null, new String[0])),

    RIGHTS_COPYRIGHT_OTHER_RESTRICTIONS("rightsCopyRightOtherRestrictions", new FileSetMetaData(
	    "rights", "copyright", null, new String[0]));

    public static final String[] DUBLIN_CORE_QUALIFIER_CONTRIBUTOR = { "advisor", "author", "editor",
	    "illustrator", "other" };

    public static final String[] DC2SCORM_QUALIFIER_CONTRIBUTOR_MAP = { "Validator", "Author", "Editor",
	    "Graphical Designer", "Unknown" };
	...
	throw new NullPointerException("Unable to convert value " + value
		+ " from Dublin Core to Scorm dcValues=" + Arrays.deepToString(dcValues));
    }
    ...
    public static final String[] METADATA_INFO_KEYS = { "title", "keyword", "generalLanguage",
	    "generalCatalog", "generalEntry", "generalStructure", "generalAggregationLevel",
	    "lifecycleVersion", "lifecycleStatus", "metametadataIdentifier", "metametadataCatalog",
	    "metametadataEntry", "metametadataContributorRole", "metametadataContributorvcard",
	    "metametadataContributordate", "metametadataMetadataschema", "metametadataLanguage",
	    "technicalSize", "technicalLocation", "technicalType", "technicalName",
	    "technicalMinimumversion", "technicalMaximumversion", "technicalInstallation",
	    "technicalOtherplatformrequirements", "technicalDuration", "educationalInteractivitytype",
	    "educationalInteractivitylevel", "educationalSemanticdensity",
	    "educationalIntendedenduserrole", "educationalContext", "educationalTypicalagerange",
	    "educationalDifficulty", "educationalTypicallearningtime", "educationalDescription",
	    "educationalLanguage", "rightsCost", "rightsDescription",
	    "relationResourceCatalogEntryCatalog", "relationResourceDescription", "annotationPerson",
	    "annotationDate", "annotationDescription", "classificationTaxonpathSource",
	    "classificationTaxonId", "classificationTaxonEntry", "classificationDescription",
	    "classificationKeyword", "description", "coverage", "contributeRole", "vcard", "date",
	    "resourceFileCreationDate", "format", "learningResource", "relationKind",
	    "relationResourceCatalogEntryEntry", "rightsCopyRightOtherRestrictions", "radiochoice" };

    public static final String[] METADATA_INFO_KEYS_MANDATORY = { "title", "generalCatalog",
	    "generalEntry", "keyword", "generalLanguage", "description", "contributeRole", "vcard",
	    "lifecycleVersion", "date", "resourceFileCreationDate", "lifecycleStatus",
	    "rightsCopyRightOtherRestrictions", "radiochoice", "metametadataMetadataSchema", "format",
	    "technicalLocation", "rightsCost", "generalAggregationLevel", "technicalDuration",
	    "educationalInteractivitytype", "learningResource", "educationalContext",
	    "rightsDescription" };
	...
	if (enumKey.compareToIgnoreCase(GENERAL_CATALOG.metadataSimpleName) == 0) {
	    ...
	    retVal.setValues(new String[] { (String) metaInfoFromForm
		    .get(GENERAL_ENTRY.metadataSimpleName) });
	}
	// else
    ...
    public static Collection<FileSetMetaData> createFileSetMetaDataColFromHash(
	    HashMap<String, Object> metaInfoFromForm) {
	Collection<FileSetMetaData> retval = new ArrayList<FileSetMetaData>(
		ScormMetaInfoEnum.values().length);
	for (ScormMetaInfoEnum current : ScormMetaInfoEnum.values()) {
    ...
    public static ScormMetaDataHash createScormMetaDataHashFromFileSetMetaData(
	    Collection<FileSetMetaData> fsMetaData) {
    ...
    public static void populateScormMetaDataHashFromFileSetMetaData(FileSetMetaData fsMetaData,
	    ScormMetaDataHash hash) {
	hash.put(fsMetaData.getElement(), fsMetaData.getQualifier(), fsMetaData.getLang(), fsMetaData
		.getValues());
    }
    ...
    /**
         ...
         * @return
         */
    public static ScormMetaDataHash createScormMetaDataHashFromUIFormData(
	    HashMap<String, Object> hashmapScormParam) {
