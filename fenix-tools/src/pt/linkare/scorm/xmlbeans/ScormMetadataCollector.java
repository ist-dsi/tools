        ...
        if (rType != null) {
            ...
            if (cType != null) {
                ...
                if (sType != null) {
                    ...
                    if (langStrType != null) {
                        if (langStrType.getStringValue().compareToIgnoreCase(
                                ImsManifestReader_1_2.IMS_MANIFEST_READER_LOM_VERSION) == 0) {
                                            ...
                                            if (lStrType != null) {
                                                ...
                                                for (String strVal : ImsManifestReader_1_2.DUBLIN_CORE_QUALIFIER_CONTRIBUTOR) {
                                                    if (strRole.compareToIgnoreCase(strVal) == 0) {
                                                        if (strVal.compareToIgnoreCase("author") == 0
                                                                || strVal.compareToIgnoreCase("editor") == 0) {
                                                            qualifier = strRole;
                                                        }
                                                        break;
                                                    }
