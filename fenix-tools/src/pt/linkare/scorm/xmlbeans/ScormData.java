...
public class ScormData {
    ...
    public ScormData(File originalPifFile, File metaDataFile,
            Collection<ScormAsset> assets,
        ...
        try {
            ...
            if (assets != null && assets.size() != 0)
                ...
                throw new ScormException(
                        "Size of Asset Collection equal to zero(0).");
    ...
    private void print(PrintWriter out) {
        out.println("Original Pif File: "
                + getOriginalFile().getAbsolutePath());
    ...
    public void printScormAssetsCollection(Collection<ScormAsset> sas,
            PrintWriter out) {
