...
public class ImsManifestReader_1_2 {
    ...
    public static final String[] DUBLIN_CORE_QUALIFIER_RELATION={"isformatof","ispartof","ispartofseries","haspart","hasformat","isversionof","hasversionof","hasversion","isbasedon","isbasisfor","isreferencedby","isrequiredby","requires","references","replaces","isreplacedby","uri"};
                    ...
                    {    
                        ...
                        if(metaDType!=null)
                        {
                            ...
                            {   
                                ...
                                scormAssetToAdd0.setContentMetadataInfo(imsR.getMetaDataFromMetaOrLomXMLFile(scormAssetToAdd0.getMetadataFile()));
                                ...
                                {   
                                    ...
                                    {
                                        ScormAssetCreationForFileTypes(fileType,scormAssetToAdd0,metaDataXmlFileLocation,xmlBaseAux2,colScormAssets,colResourceFiles0,imsR);                                        
                                    }
                                ...
                                else
                                {
                                    ...
                                    {
                                        throw new ScormException("Resource File location not encountered.ResourceType href attribute not found,nor are any FileTypes present.");
                                    } 
                                }                                
                            }
                            else
                            {
                                ...
                                {//estamos perante um resource com metadata mas onde o File é representado no
                        ...
                        else 
                        {
                            ...
                            {   
                                ...
                                if(colResourceFiles0.size()>0)
                                {
                                    scormAssetToAdd0.setContentMetadataInfo(imsR.getMetaDataFromMetaOrLomXMLFile(manType.getMetadata()));                                    
                                    scormAssetToAdd0.setContentFiles(colResourceFiles0);
                                    colScormAssets.add(scormAssetToAdd0);
                                }
                            }
    ...
    private void ScormAssetCreationForFileTypes(FileType fileType,ScormAsset scormAssetToAdd0,String metaDataXmlFileLocation,String xmlBaseAux2,Collection<ScormAsset> colScormAssets,Collection<File> colResourceFiles0,ImsManifestReader_1_2 imsR) throws Exception
    {
        try{
            ...
            if(metaDataType!=null)
            {
                ...
                if(metaDataXmlFileLocation!=null&&metaDataXmlFileLocation.length()>0)
                {                                                     
                    ScormAssetCreationWithExternalMetaData(colScormAssets,imsR,scormAssetToAdd1,fileType,xmlBaseAux2,metaDataXmlFileLocation);                                                
                }
                else
                {
                    //XXX put the 1º argument from manifestFile -> null
                    ScormAssetCreationWithInternalMetaData(null,colScormAssets,imsR,scormAssetToAdd1,fileType,xmlBaseAux2,metaDataType);                                                                                                
                }
            }
            else
            {
    ...
    private void ScormAssetCreationWithExternalMetaData(Collection<ScormAsset> colScormAssets,ImsManifestReader_1_2 imsR,ScormAsset scormAssetToAdd1,FileType fileType,String xmlBaseAux2,String metaDataXmlFileLocation) throws Exception
    {
        try
        {
    ...
    private void ScormAssetCreationWithInternalMetaData(File manifestFile,Collection<ScormAsset> colScormAssets,ImsManifestReader_1_2 imsR,ScormAsset scormAssetToAdd1,FileType fileType,String xmlBaseAux2,MetadataType metaDataType) throws ScormException
    {
        try
        {
            Collection<File> colResourceFiles1=new ArrayList<File>();
    ...
    private Collection<String> getManifestMetaDataRecursive(ManifestType manType,Collection<String> colLocations,String xmlBase) throws ScormException//XmlException,IOException,Exception
    {           
        if(manType!=null)       
        {                
    ...
    private Collection<String> getItemsMetaDataRecursive(ItemType[] iTypeArray,Collection<String> colLocations,String xmlBase) throws ScormException//Exception
    {
        try
        {
            if(iTypeArray!=null)
    ...
    private Collection<String> getLomTechnicalLocation(MetadataType metaType,Collection<String> colLocations) throws ScormException
    {
        try{
            if(metaType!=null)
            {                    
...
//  Given a MetaDataType gives it's adlcp:Location value
    private Collection<String> getLocationFromMetadata(MetadataType metaType,Collection<String> colLocations,String locXmlbase) throws ScormException//Exception
    {
        NodeList nodeList=null;
        LocationType lType=null;
        String locXmlBaseAux=null;
        ...
        try
        {
            ...
            if(metaDoc!=null)
            {
                ...
                if(metaType!=null)
                {
                    ...
                    while(pos<nodelist.getLength()&&(!nodelist.item(pos).getNodeName().startsWith("lom")&&!nodelist.item(pos).getNodeName().endsWith(":lom")))
                    {
                        pos++;
                    }
                    LomDocument lomDocument=null;
...
//  out of the imsmanifest.xml file
    public Collection<ScormMetaData> readManifestData(File imsManifestFile,Collection<String> externalMetadataFiles) throws ScormException//IOException,XmlException
    {
        Collection<ScormMetaData> colItemMetaDataToReturn=new ArrayList<ScormMetaData>();
        Collection<ScormMetaData> colItemMetaDataAux=null;
