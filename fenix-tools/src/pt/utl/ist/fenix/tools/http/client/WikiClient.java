...
public class WikiClient {
    ...
    private static void processRequest(final String wikiHost, final String wikiPort, final String wikiUsername,
            final String wikiPassword, final String wikiPage, final String outputFilename) {
        try {
    ...
    protected static void executeMethod(final HttpClient httpClient, final GetMethod method) throws IOException, HttpException {
