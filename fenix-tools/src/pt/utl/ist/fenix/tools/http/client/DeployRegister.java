...
public class DeployRegister {
    ...
    private static void appendExistingPage(final String wikiHost, final String wikiPort, final String wikiPage,
        ...
        try {
            ...
            if (response == null || response.length() == 0) {
                stringBuilder.append("||'''Programmer'''||'''Hour'''||'''Application(s)'''||'''CVS Branch'''||'''CVS Tag'''||'''Motive for deploy'''||\n");
            } else {
    ...
    private static void postPage(final String wikiHost, final String wikiPort, final String wikiPage,
    ...
    protected static String executeMethod(final HttpClient httpClient, final GetMethod method)
