...
public class ContentFileManager extends DSpaceFileManager implements IContentFileManager {
	...
	public FileDescriptor addFileToItem(VirtualPath path, String name, String itemId, boolean privateFile, InputStream fileInputStream) {
		File dirTemp;
	...
	private FileSetDescriptor addFileToItem(VirtualPath path, String name, String itemId, boolean privateFile,
			FileSet fileSet) {
		try {
