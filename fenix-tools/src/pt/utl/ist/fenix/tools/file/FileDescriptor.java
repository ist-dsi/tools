...
public class FileDescriptor implements Serializable, XMLSerializable {
	...
	public FileDescriptor(String originalAbsoluteFilePath, String filename, String mimeType, String checksum,
			String checksumAlgorithm, Integer size, String uniqueId) {
