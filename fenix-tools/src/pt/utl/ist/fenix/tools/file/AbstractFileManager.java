...
public abstract class AbstractFileManager implements IFileManager {
    ...
    public void formatDownloadUrls(FileSetDescriptor fileSetDescriptor) {
        try {
            recurseFileSetDescriptorCallMethod(fileSetDescriptor,
                    this.getClass().getMethod("formatDownloadUrlAtLevel", new Class[] { FileSetDescriptor.class }));
    ...
    public FileDescriptor saveFile(VirtualPath filePath, String originalFilename, boolean privateFile,
        ...
        originalFilename =
                StringNormalizer.normalizePreservingCapitalizedLetters(pt.utl.ist.fenix.tools.util.FileUtils
