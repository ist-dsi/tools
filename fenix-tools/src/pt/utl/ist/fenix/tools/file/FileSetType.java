...
public enum FileSetType {
	SIMPLE(SimpleFileSetFilter.class), 
	PACKAGE_SCORM_1_2(ScormFileSetFilter.class), 
    UNPACKAGED_SCORM_1_2,
	APP_DOC, 
	APP_EXCEL, 
	APP_PDF, 
	IMAGE_GIF(SimpleFileSetFilter.class,SimpleImageFileSetFilter.class), 
	IMAGE_JPG(SimpleFileSetFilter.class,SimpleImageFileSetFilter.class), 
	IMAGE_PNG(SimpleFileSetFilter.class,SimpleImageFileSetFilter.class), 
