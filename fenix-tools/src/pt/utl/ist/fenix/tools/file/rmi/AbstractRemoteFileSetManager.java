...
public abstract class AbstractRemoteFileSetManager implements IRemoteFileSetManager {
	...
	public FileSetDescriptor uploadFileSet(IRemoteFile remoteBaseDir,FileSetUploadRequest request, String username, String password)
			throws FileSetUploadException, RemoteException {
		try {
			return uploadFileSet(new File(remoteBaseDir.getAbsolutePath()), request.getOriginalFilename(), request.getPath(), request.getFileSet(), username, password);
		}
		catch (IOException e) {
	...
	public void deleteFileSet(FileSetDeleteRequest request, String username, String password)
			throws FileSetDeleteException, RemoteException {
	...
	public abstract FileSetDescriptor uploadFileSet(File baseDir,String originalFileName,VirtualPath path,FileSet fs,String username,String password) throws IOException;
	public abstract File createTemporaryUploadDirectory(String username,String password) throws IOException;
	public abstract File materializeFileSetToTemporaryDirectory(FileSetDescriptor descriptor,String username,String password) throws IOException;
}
