...
public class JoinSQLScripts {
    ...
    private static PrintWriter constructRunPrintWriter(String outputFile) throws FileNotFoundException {
        ...
        printWriter.append("echo Enter password for $USER:\n");
    ...
    private static List<String> loadSQLScripts(final SortedMap<String, File> directoryTree, final String fromDirName) throws IOException {
